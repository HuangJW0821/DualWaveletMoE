...
class TimeMoeRunner:
    ...
    def train_model(self, from_scratch: bool = False, **kwargs):
        ...
        # class TimeMoETrainingArguments is herit from transformers.TrainingArguments
        ...
        # check model_path
        # if train from scatch, load model by init a class TimeMoeForPrediction object
        ...
        # Training
        # load dataset
        # first load dataset by class TimeMoEDataset
        # then process it into fixed-size sub-sequences by class TimeMoEWindowDataset
    ...
    # Mind this: dataset loader class
