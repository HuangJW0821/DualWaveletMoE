...
class TimeMoEDataset(TimeSeriesDataset):
    ...
    def __init__(self, data_folder, normalization_method=None):
        ...
        # set seq norm method, ie scaling method
        # max for max scaling, zero for z-scaling
        ...
        # load data from class BinaryDataset or GeneralDataset
        # BinaryDataset for bin dataset
        # GeneralDataset for genral format like json, pkl, ext. 
        if BinaryDataset.is_valid_path(self.data_folder):
            ...
            # Mind this: maybe we could use it to load .parquet, or add a class for .parquet
        ...
        for ds in self.datasets:
            # use cumsum to index ds offset in ds list
