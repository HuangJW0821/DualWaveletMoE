...
class TimeMoEWindowDataset:
    ...
    Attributes:
        ...
        prediction_length (int): Length of the prediction window. Defaults to 0 (for auto-regression).
    ...
    def __getitem__(self, seq_idx):
        ...
        # Mind this: seem to be wrong?
        return {
            'input_ids': seq[:-1],      # input_ids = [x0, x1, ..., x(n-1)]
            'labels': seq[1:],          # labels = [x1, x2, ..., xn]
