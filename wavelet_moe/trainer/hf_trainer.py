...
class WaveletMoeTrainer(transformers.Trainer):
    ...
    def __init__(self, needed_column_names: List[str], *positional_args, **kwargs):
        super().__init__(*positional_args, **kwargs)
        self.tokenizer = kwargs.get("tokenizer", None)
        self.needed_column_names = needed_column_names
...
@dataclass
class WaveletMoETrainingArguments(transformers.TrainingArguments):
